...
plot 'impact-d-vm' \
	using 1:($2)*100 w lp ls 1 title "User1", \
"" using 1:($4)*100 w lp ls 2 title "User2", \
"" using 1:($6)*100 w lp ls 3 title "User3", \
"" using 1:($8)*100 w lp ls 4 title "User4", \
"" using 1:($10)*100 w lp ls 5 title "User5", \
"" using 1:($12)*100 w lp ls 6 title "User6"
...
"" using 1:($9)*100 w lp ls 4 notitle, \
"" using 1:($11)*100 w lp ls 5 notitle, \
"" using 1:($13)*100 w lp ls 6 notitle
