...
plot 'effectiveness-fsl-with-size' \
		 using ($2*100):xtic(1) with histogram ls 1 fill pattern 6 title "w = 1", \
''		 using ($3*100):xtic(1) with histogram ls 2 fill pattern 2 title "w = 2", \
''		 using ($4*100):xtic(1) with histogram ls 3 fill pattern 4 title "w = 3" 
